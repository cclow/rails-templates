...
//    omplete: A function to call when a new page has been loaded (optional)
...
(function($) {
    ...
    $.pageless.settings = {
        ...
        url: location.href,
        params: {},
        // params of the query you can pass auth_token here
        distance: 100,
        // page distance in px to the end when the ajax function is launch
  ...
  <img src="' + $.pageless.settings.loaderImage + '" title="load" alt="loading more results" style="margin: 10px auto" />\
    ...
    $.pageless.scroll = function() {
        ...
        if (!$.pageless.isLoading && (distance < $.pageless.settings.distance)) {
            ...
            // finally ajax query
            $.get($.pageless.settings.url, $.pageless.settings.params,
            function(data) {
